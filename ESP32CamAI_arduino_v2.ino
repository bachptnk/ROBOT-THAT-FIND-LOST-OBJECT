...
//Creating UDP (send all information from esp32 to android) Listener Object. 
WiFiUDP UDPServer;
...
const unsigned long intervalServo = 10; //change servo speed
bool servoUp = false;
bool servoDown = false;
bool servoRotateLeft = false;
bool servoRotateRight = false;
int posServo = 80;  //the first angle of the servo
